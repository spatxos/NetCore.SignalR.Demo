...
var WebSocketTransport = /** @class */ (function () {
    function WebSocketTransport(accessTokenFactory, logger, logMessageContent,data) {
        this.logger = logger;
        this.accessTokenFactory = accessTokenFactory || (function () { return null; });
        this.logMessageContent = logMessageContent;
        this.data = data;
...
var HttpConnection = /** @class */ (function () {
    ...
    HttpConnection.prototype.createConnectUrl = function (url, connectionId) {
        return url + (url.indexOf("?") === -1 ? "?" : "&") + ("id=" + connectionId) + jsontostr(this.options, "&");//Ìí¼Ó£¬+ jsontostr(this.options,"&")
    };
...
//Ìí¼Ó
var jsontostr = function (options, char) {
    var result = "";
    if (options) {
        Object.keys(options).sort().map(function (optionkey) {
            var option_key = encodeURIComponent(optionkey);
            var obj_val = options[option_key];
            result += char + option_key + "=" + obj_val;
        });
    }
    return result;
}